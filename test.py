...
model = load_model('./model/my_model_epochs30.h5')
...
# spectral.save_rgb("./result/ground_truth.png", y, format='png', colors=spectral.spy_colors)
# In[17]:


predict_image = spectral.imshow(classes=outputs.astype(int), figsize=(5, 5))
# spectral.save_rgb("./result/predict_image.png", outputs, format='png', colors=spectral.spy_colors)
